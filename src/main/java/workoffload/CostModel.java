...
public class CostModel {
	static public ICostModel responseTime() {
		return new ResponseTime();
	}

	static public ICostModel energyConsumption(float computing, float idling, float transmitting) {
		return new EnergyConsumption(computing, idling, transmitting);
	}

	static public ICostModel weightedTimeAndEnergy(float computing, float idling, float transmitting, float omega) {
		return new WeightedTimeEnergy(computing, idling, transmitting, omega);
	}

	static class ResponseTime implements ICostModel {
	...
	static class EnergyConsumption implements ICostModel {
	...
	static class WeightedTimeEnergy implements ICostModel {
